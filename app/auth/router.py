...
from JWTToken import token_schemas, JWTExeption
...
async def registrate(user_credentials : UserRegistrationCredentialsIn) -> token_schemas.IssuedJWTTokensOut:
...
async def login(user_credentials : UserLoginCredentialsIn) -> token_schemas.IssuedJWTTokensOut:
...
async def update_tokens(user_credentials : RefreshTokenIn) -> token_schemas.IssuedJWTTokensOut:
