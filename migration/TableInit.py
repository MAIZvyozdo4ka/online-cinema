        ...
        with open(file_name, 'r') as readed_file:
            with open(new_file_name, 'w+') as write_file:
                for user in readed_file:
                    ...
                    password = sha256(str.encode(username)).hexdigest()
                    
                    user = [id, username, first, last, email, password]
...
#DatabaseRandomRowsGenrator.clear_user_csv('migration/versions/csv_data/users.csv', 'migration/versions/csv_data/users_clear.csv')               